...
! === READ & OUTPUT FOLDER ============
  character(*) ,parameter :: dir_r = '/project/si22/jdp46/sp25/Test1/MHD/'
  character(*) ,parameter :: dir   = '/project/cstr/Jaiman/sp25/Test2/VAPOR/Merge/'
  character(*) ,parameter :: dir_a = '/project/cstr/Jaiman/sp25/Test2/VAPOR/'
