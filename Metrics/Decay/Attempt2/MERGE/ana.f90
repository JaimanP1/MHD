...
!  close(11)
!
!  open(12,file = dir//'VZ.'//trim(cloop),form='formatted')
!  do i = 0, nx_r
!  do k = 0, nz_r
!     write(12,*) i,k,vz_r(i,ny_r/2,k)
!  end do
!     write(12,*)' '
!  end do
!  close(12)
...
!  open(11,file = dir//'CT_2D.'//trim(cloop),form='formatted')
!  do k= 0, nz_r
!        write(11,*) k,ct(210,210,k)
!  end do
!  close(11)
!
! open(12,file = dir//'CT_BOTTOM', form='formatted')
!        write(12,*) ct (210,210,1)
!
! open(13, file = dir//'CT_SLICE.'//trim(cloop),form='formatted')
! do i= 0, nx_r-3
! do k= 0, nz_r-3
!        write(13,*) i, k, ct (i,210,k)
! end do
! end do
! close(13)
!
! open(13, file = dir//'CT_BT_2D.'//trim(cloop),form='formatted')
! do i= 0, nx_r-3
! do k= 0, nz_r-3
!        write(13,*) i, k, ct(i,210,k)/bt(i,210,k)
! end do
! end do
! close(13)
...
!  bz_flux = bz_flux/8.0
!
!  open(13, file = dir//'FLUX.'//trim(cloop), form='formatted')
!        write (13,*) atime, bz_flux
!  close(13)
